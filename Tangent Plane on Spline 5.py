...
def run(context):
    ...
    try:
        ...
        #    points[i].add(adsk.core.Point3D.create(points_float[i][0], points_float[i][1], points_float[i][2]))
            #spline.append(sketch.sketchCurves.sketchFittedSplines.add(points[i]))
