...
def create_body(rootComp, points_float, radius, spline, ui):
...
def run_along_spline(number_of_construction_planes, planeInput, crvPath_spline, planes, radius, sketches, rootComp, ui):
...
def run(context):
    ...
    try:
        ...
        planeInput, crvPath_spline, planes, sketches = create_body(rootComp, points_float, radius, spline, ui)
        ...
        run_along_spline(number_of_construction_planes, planeInput, crvPath_spline, planes, radius, sketches, rootComp, ui)
