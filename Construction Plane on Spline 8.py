    ...
    try:
        ...
        for i in range (100):
            ...
            if i == 1:
                ...
                #TESTING
                #plane object is a read only value
                ...
                ui.messageBox("This is the location of the u_vector" +"X = "+str(u_vector.x)+ "  Y = " + str(u_vector.y) + "  Z = "+str(u_vector.z))
                ui.messageBox("This is the length of the u_vector is:" + str(u_vector.length))
                ui.messageBox("This is the location of the v_vector" +"X = "+str(v_vector.x)+ "  Y = " + str(v_vector.y) + "  Z = "+str(v_vector.z))
                ui.messageBox("This is the length of the v_vector is:" + str(v_vector.length)) 

                ui.messageBox("The cross product of u and v is:" +"X = "+str(cross_product_u_v.x)+ "  Y = " + str(cross_product_u_v.y) + "  Z = "+str(cross_product_u_v.z))
                #plane_i.attributes.isVisible = bool(False)
                vis = plane_i.isVisible 
                ui.messageBox("The plane is visible:" + str(vis))

                #attributes = plane_i.attributes
                #ui.messageBox("These are the attributes:" + str(attributes))

                geo = plane_i.geometry
                ui.messageBox("These is the geometry:" + str(geo))

                trans = plane_i.transform
                ui.messageBox("These is the transform:" + str(trans))
