...
def run(context):
    ...
    try:
        ...
        number_of_points = 11 #Number of points for Spline
        ...
        points_float[4]= [0,0,30]
        points_float[5]= [10,0,30]
        points_float[6]= [20,0,45]
        points_float[7]= [20,-10,70]
        points_float[8]= [20,-15,90]
        points_float[9]= [20,0,120]
        points_float[10]= [20,10,130]
        ...
        for i in range (400):
            ...
            distance = adsk.core.ValueInput.createByReal(i/400) 
