...
def run(context):
    ...
    try:
        ...
        #Create Body 
        planeInput, crvPath_spline, planes, sketches = create_body(points_float_set_1, radius, spline1)
        #planeInput2, crvPath_spline2, planes2, sketches2 = create_body(points_float_set_2, radius, spline2)
        #planeInput3, crvPath_spline3, planes3, sketches3 = create_body(points_float_set_3, radius, spline3)
