...
def construction_plane_from_three_points(sketches):
        app = adsk.core.Application.get()
        ui  = app.userInterface
        design = app.activeProduct
        rootComp = design.rootComponent
...
def run(context):
    ...
    try:
        ...
        #Create Second Body
        plane_2 = construction_plane_from_three_points(sketches)
        ...
        run_along_spline_of_pipe(number_of_construction_planes, planeInput2, crvPath_spline2, planes2, outter_radius, sketches2)
