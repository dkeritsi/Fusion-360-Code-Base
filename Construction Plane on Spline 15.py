...
def run(context):
    ...
    try:
        ...
        points_float_set_1 = [[0]*3 for i in range (number_of_points)]
        ...
        #Second Path 
        number_of_points2 = 4 #Number of points for Spline
        points_float_set_2 = [[0]*3 for i in range (number_of_points)]
        ...
        #Third Path 
        number_of_points3 = 4 #Number of points for Spline
        points_float_set_3 = [[0]*3 for i in range (number_of_points)]
        ...
        construction_of_splines(points, points_float_set_1, spline, sketch, number_of_points) 
        construction_of_splines(points2, points_float_set_2, spline2, sketch2, number_of_points2) 
        construction_of_splines(points3, points_float_set_3, spline3, sketch3, number_of_points3) 
